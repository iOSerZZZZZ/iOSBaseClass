...
- (void)initUI{
    ...
    self.tableView = [[ShareWorkBaseTableView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(calendarView.frame), CGRectGetWidth(self.frame), CGRectGetHeight(self.frame)-CGRectGetMaxY(calendarView.frame))];
    ...
    self.tableView.emptyText = @"暂无数据";
    self.tableView.emptyImg = [UIImage imageNamed:@"table_nodata"];
