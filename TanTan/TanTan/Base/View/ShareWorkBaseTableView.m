...
@interface ShareWorkBaseTableView ()<DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>

@property (nonatomic, strong) UIColor *lastColor;

@end

@implementation ShareWorkBaseTableView
...
- (UIView *)customViewForEmptyDataSet:(UIScrollView *)scrollView
{
    ...
    ShareWorkCustomEmptyView *view = [[ShareWorkCustomEmptyView alloc] init];
